...
<?php 
	...
	<header>
        ...
        <div class="container4">
            <h2>Sản phẩm quần áo nam thời trang nam mới nhất</h2>
                ...
                while ($row = mysqli_fetch_array($products)) {
                    ...
                    <div class="product-item">
                        <div class="product-img">
                            <a href="detail.php?id=<?= $row['masp'] ?>"><img src="<?= $row['img'] ?>" title="<?= $row['tensp'] ?>" /></a>
                        </div>
                        <strong><a href="detail.php?id=<?= $row['masp'] ?>"><?= $row['tensp'] ?></a></strong><br/>
